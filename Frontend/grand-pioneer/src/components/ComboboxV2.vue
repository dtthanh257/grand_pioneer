<template>
    <div class="combo-box flex-c" ref="comboBox" :class="{ comboboxv3: isV3, 'border-bottom-blue': !white }">
        ...
        <div class="combobox-input-container overflow-hidden" :class="{

            'comboboxv3-input-container': isV3,
        }" :style="{ width: width + 'px' }">
            <input style="background-color: transparent;" type="text" class="combobox-input blue"
                @click="toggleDropdown" v-model="inputValue" @input="emitInputValue" :placeholder="this.fetchValue">
